...
impl FromStr for ContentType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        // agy/go-keyring stores `text/plain; charset=utf8`. crates.io 0.6.0
        // required an exact match; upstream parse-before-';' is oo7#517.
...
mod tests {
    ...
    fn content_type_from_str() {
        ...
        assert_eq!(
            ContentType::from_str("text/plain; charset=utf8").unwrap(),
            ContentType::Text
        );
