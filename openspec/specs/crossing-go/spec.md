# crossing-go Specification

## Purpose

Flags the moment a running 5-hour quota is ready to spend across its upcoming reset: use the unused leftover and catch the next window so the quota is not wasted.
