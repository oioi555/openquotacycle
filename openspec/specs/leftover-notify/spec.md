...
A Linux leftover-melting notification SHALL display the OpenQuotaCycle app icon. It SHALL NOT show an empty image slot. The popup SHALL remain visible until the user dismisses it.
...
- **THEN** the notification card displays the OpenQuotaCycle icon
